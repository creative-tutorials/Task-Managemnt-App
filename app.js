...
async function authorizeGoogleAuth() {
   ...
   .then((result) => {
     ...
     load_bx.classList.add("active");
        ...
        setTimeout(() => {
            console.log("Form has being submitted");
...
form.addEventListener("submit", (e) => {
    ...
    function validate() {
        ...
        if(!emailInput.value.match(regexPattern)){
            emailInput.classList.add("invalid");
            errorMsg.classList.add("invalid");
            (emailInput.value != "") ? errorMsg.textContent = "Enter a valid email address" : errorMsg.textContent = "Please fill the required fields";
        }else{
